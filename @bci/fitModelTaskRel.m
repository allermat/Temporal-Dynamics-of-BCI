function [negLogLike,mdlEval] = fitModelTaskRel(parameters,parameterNames,dataVA,responseLoc)
...
% USAGE:
%   [logLike,all] = bci.fitModelTaskRel(parameters,parameterNames,dataVA,responseLoc)
% INPUT:
